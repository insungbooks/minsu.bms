			...
			<div class="tab-content">
				<div id="productInfo" class="tab-pane fade in active">
					...
					<div class="text" style="border: 1px solid black;">대통령 말이면 안
						되는 일이 없는 이 나라에서 대통령이 올바른 판단력을 지니고 있지 못하다면 그 뒷감당은 누가 해야 하는가. 결국 우리는
						지금 비싼 대가를 치르고 있다. 이 상처를 치유하는 데 오랜 세월이 필요할 것이다. 저자는 이제 유권자들도 정신 차려야
						한다고 일갈한다.</div>
					<hr>
					<h3>저자소개</h3>
					...
					<hr>
					<h3>출판사 서평</h3>
					<div class="text" style="border: 1px solid black;">『민주주의의 원칙에
						따라 대통령을 뽑았더니 박근혜 정부 꼴이라면 민주주의를 폐기해야 마땅하지 않을까. 대통령 말이면 안 되는 일이 없는 이
						나라에서 대통령이 올바른 판단력을 지니고 있지 못하다면 그 뒷감당은 누가 해야 하는가. 결국 우리는 지금 비싼 대가를
						치르고 있다. 이 상처를 치유하는 데 오랜 세월이 필요할 것이다. 저자는 이제 유권자들도 정신 차려야 한다고 일갈한다.
						주인 노릇을 제대로 하라는 말이다. 그러나 희망의 끈을 놓지 않을 수 있는 이유는 지금의 이 과정이 결국 새로운 기회로
